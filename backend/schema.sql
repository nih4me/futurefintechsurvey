/* ============================================================
   ...
   Purpose : Store SurveyJS responses for Fellows Submissions
   Key     : Alphanumeric submission_id (no authentication)
...
/* ============================================================
   1. Submissions (ROOT TABLE)
   ============================================================ */

CREATE TABLE submissions (
  submission_id CHAR(20) PRIMARY KEY,
  submission_year INT NOT NULL DEFAULT 2026,
...
CREATE TABLE events (
  ...
  INDEX idx_events_app (submission_id)
) ENGINE=InnoDB;
...
CREATE TABLE grants_projects (
  ...
  INDEX idx_grants_app (submission_id)
) ENGINE=InnoDB;
...
CREATE TABLE partnership_projects (
  ...
  INDEX idx_partnerships_app (submission_id)
) ENGINE=InnoDB;
...
CREATE TABLE publications (
  ...
  INDEX idx_publications_app (submission_id)
) ENGINE=InnoDB;
...
CREATE TABLE phd_students (
  ...
  INDEX idx_phd_app (submission_id)
) ENGINE=InnoDB;
...
CREATE TABLE awards (
  ...
  INDEX idx_awards_app (submission_id)
) ENGINE=InnoDB;
...
CREATE TABLE press_appearances (
  ...
  INDEX idx_press_app (submission_id)
) ENGINE=InnoDB;
